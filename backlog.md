...
**Phase 4 — "Depth & memorable moments"** ← **next up (only remaining active work)**
G11 Narrative Events (with G4 objectives folded in) → G14 Achievements. ~~G15 Run Legacy~~ skipped; ~~G6 Rotation Bonus~~ skipped; F3 remaining juice (optional polish).
